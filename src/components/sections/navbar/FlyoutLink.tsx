    ...
    <div className="grid xl:grid-cols-4 gap-4 xl:gap-8 pb-2 xl:max-w-[90dvw]">
      ...
      <div className="flex flex-col gap-4 xl:min-w-[260px] w-full xl:max-w-[310px]">
        ...
        <div className="flex flex-col gap-2 xl:gap-5">
          ...
          <PLink color="var(--color-gold)" title="For Enterprise" text="An enterprise-ready AI platform that powers modern workplace productivity" link="/products/predictive-ai-models/for-enterprise" />
          <PLink color="var(--color-gold)" title="For VCs & Investors" text="An enterprise-ready AI platform that powers modern workplace productivity" link="/products/predictive-ai-models/for-vcs-and-investors" />
        </div>
      ...
      <div className="flex flex-col gap-4 xl:min-w-[260px] w-full xl:max-w-[310px]">
        ...
        <div className="flex flex-col gap-2 xl:gap-5">
          ...
          <PLink color="#009DFF" title="Horion For Sales" text="An enterprise-ready AI platform that powers modern workplace productivity" link="/products/generative-ai/horion-for-sales" />
          <PLink color="#009DFF" title="Horion For HR" text="An enterprise-ready AI platform that powers modern workplace productivity" link="/products/generative-ai/horion-for-hr" />
        </div>
      ...
      <div className="flex flex-col gap-4 xl:min-w-[260px] w-full xl:max-w-[310px]">
        ...
        <div className="flex flex-col gap-2 xl:gap-5">
          ...
          <PLink color="#ff0000" title="AI Agents For Enterprise" text="An enterprise-ready AI platform that powers modern workplace productivity" link="/products/agentic-ai/ai-agents-for-enterprise" />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 xl:min-w-[260px] w-full xl:max-w-[310px]">
        ...
        <div className="flex flex-col gap-2 xl:gap-5">
          ...
          <PLink color="#4000FF" title="Awfarli AI" text="An enterprise-ready AI platform that powers modern workplace productivity" link="/products/ai-for-retailers/awfarli-ai" />
        </div>
  ...
  return (
    <div className="flex xl:min-w-[320px] flex-col gap-4 text-black">
      ...
      <div className="flex flex-col ">
        ...
        <FLink link="/company" text="Company" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex xl:min-w-[320px] flex-col gap-5 text-black">
      ...
      <div className="flex flex-col">
        ...
        <FLink text="Lebanese Army LLM" link="/case-studies/Lebanese-Army-LLM" />
        <FLink text="Military Tribunal AI Powered Internal System" link="/case-studies/Military-Tribunal-AI-Powered-Internal-System" />
        <FLink text="Council of Ministers Internal Dashboard" link="/case-studies/Council-of-Ministers-Internal-Dashboard" />
        <FLink text="Code For Lebanon" link="/initiatives/Code-For-Lebanon" />
      </div>
    </div>
  );
}
    ...
    <div className="flex xl:w-[480px] flex-col gap-5 text-black">
      ...
      <Link className="group/link" to="/initiatives/code-for-lebanon" >
        <div className="min-w-full rounded-[10px] overflow-hidden relative aspect-square px-4 py-6 xl:p-9 flex justify-end flex-col gap-2">
          ...
          <TexturedBg color="var(--color-gold)" className="group-hover/link:scale-110 ease-in-out duration-300" />

          <div className="flex gap-6 xl:gap-8 items-center relative">
            <p className="text-[26px] xl:text-[32px] max-xl:leading-[1.1]">Code For Lebanon</p>
          ...
          <p className="relative text-base max-w-[340px] leading-[1.25]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae, minima.</p>
        </div>
      </Link>
    </div>
  );
    ...
    <div className="flex xl:w-[480px] flex-col gap-5 text-black">
      ...
      <Link className="group/link" to="/government/public-sector" >
        <div className="min-w-full rounded-[10px] overflow-hidden relative aspect-square px-4 py-6 xl:p-9 flex justify-end flex-col gap-2">
          ...
          <div className="flex gap-6 xl:gap-8 items-center relative">
            <p className="text-[26px] xl:text-[32px] max-xl:leading-[1.1]">Public Sector</p>
            <div className="xl:w-8 w-6 aspect-square group-hover/link:translate-x-3 ease-in-out delay-50 duration-150">
...
function FLink({link, text} : {link: string; text: string}) {
  return <Link className="cursor-point group/link" to={link}>
...
function PLink({color, title, text, link}: {color: string, title: string, text: string, link: string}) {
  return <Link to={link}>
    <div className="flex flex-col px-3 py-3 gap-1 xl:gap-2 hover:bg-blueish-gray/15 ease-in-out duration-150 rounded-md overflow-hidden">
      <div className="flex gap-2 items-center">
        <div className="aspect-square rounded-full w-2" style={{backgroundColor: color}}/>
